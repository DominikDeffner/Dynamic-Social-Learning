...
legend("topright", title = "Type of Change", c("Spatial", "Temporal"), col = c(alpha(col.pal[4],alpha = 0.6),alpha(col.pal[5],alpha = 0.6)), lwd = 6, bty="n")
...
abline(v=0, lty=2)
legend("topright", "Contrast", bty="n", cex=1.1) 
mtext("Density", side = 2, line = 0, outer = TRUE, cex = 1.2)
